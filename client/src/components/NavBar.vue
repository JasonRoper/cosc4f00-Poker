<template>
  <div>
      ...
      <div class="container ">
        ...
        <div class="collapse navbar-collapse justify-content-end " id="navbarNavAltMarkup">
          <div class="navbar-nav nav nav-pills mb-3 bg-lights" id="pills-tab" role="tablist">
            ...
            <a class=" nav-item  nav-link active bg-transparent active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab"
              aria-controls="pills-home" aria-selected="true">Home</a>
            <a class="nav-item nav-link bg-transparent" id="pills-features-tab" data-toggle="pill" href="#pills-features" role="tab"
              aria-controls="pills-features" aria-selected="false">Features</a>
    ...
    <!--==================*
      MODAL Login!!!
  *==================-->
    <div class="modal fade" id="Register2" tabindex="-1" role="dialog" data-backdrop="false" aria-labelledby="exampleModalLongTitle"
      aria-hidden="true">
          ...
          <div class="modal-body">
            ...
            <form>
              ...
              <div class="input-group mb-3">
                ...
                <input v-model="Player.username" type="text" class="form-control" placeholder="Username/Email" aria-label="Username/Email"
              ...
              <div class="input-group mb-3">
                ...
                <input v-model="Player.password" type="password" class="form-control" placeholder="Passowrd" aria-label="Username/Email"
                  aria-describedby="basic-addon1">
              </div>
              <!--Password input   -->
